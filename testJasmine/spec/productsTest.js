...
describe('test suite: products.js', () => {
    it('see if Product properties and methods are correct', () => {
        ...
        expect(product.getRatingURL()).toContain('images/ratings/rating-45.png');
    });

    it('see if Clothing properties and methods are correct', () => {
